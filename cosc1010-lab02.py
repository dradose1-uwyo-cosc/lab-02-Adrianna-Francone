...
# Lab 02 
# Lab Section: 15
# Sources, people worked with, help given to: Variables and Simple Types Lecture Slides
# No comments
...
string_1 = "University of Wyoming"
string_2 = "1886"

print(f"The {string_1} was founded in {string_2}")
